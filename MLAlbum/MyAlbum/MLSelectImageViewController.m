...
- (void)creatNav {
    ...
    self.navigationController.navigationBar.barTintColor = [UIhelpTools colorWithHexString:@"fcb314"];
    self.view.backgroundColor = [UIhelpTools colorWithHexString:@"f3f3f3"];
    self.navigationController.navigationBar.titleTextAttributes =
    @{NSForegroundColorAttributeName:[UIColor whiteColor],NSFontAttributeName:[UIFont systemFontOfSize:22]};
    ...
    UIButton *rightBarItemCustomButton = [[UIButton alloc]initWithFrame:CGRectMake(8,0,40,22)];
...
- (void)rightClick {
    ...
    if (selectArray.count == 0) {
        ...
        UIAlertView *aler = [[UIAlertView alloc]initWithTitle:@"提示" message:@"请选择照片" delegate:self cancelButtonTitle:@"好滴好滴" otherButtonTitles: nil];
        [aler show];
        return;
    }
